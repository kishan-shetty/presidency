...
{
	$recepient_email    = "kishanshetty17@gmail.com"; //recepient
    $from_email         = "hello@kishan.co.in"; //from email using site domain.
    //$subject            = "Attachment email from your website!"; //email subject line
    $subject            = filter_var($_POST["s_name"], FILTER_SANITIZE_STRING); //capture sender name
